...
for i in range(0, max_dataset_num):
    ...
    # transforming the content from a tring to a dictionary
    ...
    for byte in range(0,16):#range of bits 0-16:
        ...
        try:
            ...
            aisy.set_database_name(f"database_{data_type}_hyper_selec_rand_search_cnn.sqlite")
            ...
            random_search = {
                ...
                "hyper_parameters_search": {
                    ...
                    'batch_size': {"min": 100, "max": 400, "step": 100},
