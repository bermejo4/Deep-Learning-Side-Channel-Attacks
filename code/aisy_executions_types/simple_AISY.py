...
for i in range(0, max_dataset_num):
    ...
    # transforming from string to dictionary
        ...
        for batchsize in batch_sizes:
            for byte in range(0,16):#range of bits 0-16:
                try:
                    ...
                    aisy.set_database_name(f"HW_database_{data_type}_simple.sqlite")
                    aisy.set_dataset(dataset_configuration)
                    aisy.set_aes_leakage_model(leakage_model='HW', byte=byte)
