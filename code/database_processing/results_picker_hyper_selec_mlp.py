...
# print("range:"+str(list(range(analysis_id_range[0], analysis_id_range[1]))))
# print("len:"+str(len(list(range(analysis_id_range[0], analysis_id_range[1])))))
# lista_analysis_id_range = list(range(analysis_id_range[0], analysis_id_range[1]))
# for i in range(0,len(list(range(analysis_id_range[0], analysis_id_range[1])))):
#     diccionario[lista_analysis_id_range[i]]=ids[i]
...
#     leakage_model = get_leakage_model(database_file, analysis_id)
#     print("Leakage Model JSON:", leakage_model)
#     # leakage_model=json.loads(str(leakage_model))
#     success_rate_id = int(diccionario[value])
#     # Obtener hyperparameter_id para un analysis_id y success_rate_id específicos
#     # analysis_id = 4586  # Reemplaza esto con el analysis_id que deseas buscar
#     # success_rate_id = 6800  # Reemplaza esto con el success_rate_id que deseas buscar
#     hyperparameter_id = get_hyperparameter_id(database_file, analysis_id, success_rate_id)
#     #print("Hyperparameter ID encontrado:", hyperparameter_id)
#     # Obtener el valor de los hyperparameters para un hyperparameter_id específico
#     if hyperparameter_id:
#         hyperparameters = get_hyperparameters(database_file, hyperparameter_id)
#         print("Valor de hyperparameters:", hyperparameters)
#     hyperparameters = json.loads(hyperparameters)
#     json_data_renamed = {
...
#     "val_ge": hyperparameters["Val GE"],
#     "val_sr": hyperparameters["Val SR"],
#     "cipher": leakage_model["cipher"],
#     "leakage_model": leakage_model["leakage_model"],
#     "byte": leakage_model["byte"],
#     "round": leakage_model["round"],
#     "target_state": leakage_model["target_state"],
#     "direction": leakage_model["direction"],
#     "attack_direction": leakage_model["attack_direction"],
